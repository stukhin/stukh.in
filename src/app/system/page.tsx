...
const COMPONENTS = [
  ...
  { path: "components/HomeSlider", purpose: "FloatingLines-over-photo hero (desktop), 7s autoplay + progress dots" },
  ...
  { path: "components/FloatingLines", purpose: "three.js noise-driven wave lines overlay on home hero (desktop only)" },
